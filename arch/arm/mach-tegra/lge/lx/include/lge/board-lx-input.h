...
#ifndef __MACH_TEGRA_LX_INPUT_H
#define __MACH_TEGRA_LX_INPUT_H
...
#if defined (CONFIG_SENSORS_APDS990X)
extern struct apds990x_proximity_platform_data lx_prox_data;
#endif
