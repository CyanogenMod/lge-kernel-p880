...
//                                                                     
	DEFAULT_PINMUX(GMI_CS0_N,	RSVD1,		NORMAL,		NORMAL,		INPUT),  //MUIC_INIT
	...
	DEFAULT_PINMUX(GPIO_PU5,	RSVD1,		 NORMAL,	NORMAL,   OUTPUT),
...
//                                  
	DEFAULT_PINMUX(GMI_AD12,        RSVD1,		PULL_UP,	NORMAL,		INPUT),  //SENSOR_INT (MPU6050 - INT)
	DEFAULT_PINMUX(GMI_AD13,        RSVD1,		PULL_UP,	NORMAL,		INPUT),  //COMPASS_READY (AMI306 - DRDY)
//                                    
	...
	DEFAULT_PINMUX(GMI_A18,         UARTD,		NORMAL,		NORMAL,		OUTPUT),	//RGB_IC_EN
...
//                                         
	...
	DEFAULT_PINMUX(KB_ROW3,         RSVD,             PULL_UP, NORMAL,     INPUT), //YJChae for add Quickmemo
...
//                                            
	...
	DEFAULT_PINMUX(KB_ROW8,         KBC,		NORMAL,		NORMAL,		INPUT),//USB_CWR
	DEFAULT_PINMUX(KB_ROW9,		KBC,		NORMAL,		NORMAL,		OUTPUT),//USB_AWR
...
//                                                                                                                  
	DEFAULT_PINMUX(KB_ROW14,	KBC,		NORMAL,		NORMAL,     INPUT),	//cheol.gwak 0109 suspend request
...
//                                
//                                             
	DEFAULT_PINMUX(SPI2_SCK,        SPI2,            PULL_DOWN,    NORMAL,     OUTPUT),
	DEFAULT_PINMUX(SPI2_MISO,       SPI2,            PULL_DOWN,    NORMAL,     OUTPUT),
//                                             
