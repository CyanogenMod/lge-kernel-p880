/*
 * arch/arm/mach-tegra/lge/board-lx-i2c-pin-define.c
 *
...
#include <lge/board-lx-misc.h>
#include <lge/board-lx-audio.h>
#include <lge/board-lx-input.h>
...
static struct i2c_board_info __initdata lx_i2c_bus0_board_info[] = {
//                                             
...
#if defined(CONFIG_MACH_LX_REV_A)
		{
...
static struct i2c_board_info __initdata lx_i2c_bus1_board_info[] = {
...
static struct i2c_board_info __initdata lx_i2c_bus2_board_info[] = {
 /*                                                                        */
#if defined(CONFIG_REGULATOR_CAM_SUBPMIC_LP8720)
	{
...
static struct i2c_board_info __initdata lx_i2c_bus4_board_info[] = {
...
static struct i2c_board_info __initdata lx_i2c_bus5_board_info[] = {
...
static void __init lx_i2c_dev_init(void)
{
	i2c_register_board_info(0, lx_i2c_bus0_board_info,
			ARRAY_SIZE(lx_i2c_bus0_board_info));
	i2c_register_board_info(1, lx_i2c_bus1_board_info,
			ARRAY_SIZE(lx_i2c_bus1_board_info));
	i2c_register_board_info(2, lx_i2c_bus2_board_info, 
			ARRAY_SIZE(lx_i2c_bus2_board_info));
	i2c_register_board_info(4, lx_i2c_bus4_board_info, 
			ARRAY_SIZE(lx_i2c_bus4_board_info));
//                                                                                
	i2c_register_board_info(5, lx_i2c_bus5_board_info,
			ARRAY_SIZE(lx_i2c_bus5_board_info));
//                                                                                
}

static struct tegra_i2c_platform_data lx_i2c1_platform_data = {
	.adapter_nr	= 0,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data lx_i2c2_platform_data = {
	.adapter_nr	= 1,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data lx_i2c3_platform_data = {
	.adapter_nr	= 2,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data lx_i2c4_platform_data = {
	.adapter_nr	= 3,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data lx_i2c5_platform_data = {
	.adapter_nr	= 4,
	.bus_count	= 1,
	.bus_clk_rate	= { 400000, 0 },
...
//                                                                             
#ifdef CONFIG_I2C_GPIO
static struct i2c_gpio_platform_data lx_gpio_i2c_platform_data = {
...
#endif
//                                                                             
void __init lx_i2c_init(void)
{
	tegra_i2c_device1.dev.platform_data = &lx_i2c1_platform_data;
	tegra_i2c_device2.dev.platform_data = &lx_i2c2_platform_data;
	tegra_i2c_device3.dev.platform_data = &lx_i2c3_platform_data;
	tegra_i2c_device4.dev.platform_data = &lx_i2c4_platform_data;
	tegra_i2c_device5.dev.platform_data = &lx_i2c5_platform_data;
//                                                                              
#ifdef CONFIG_I2C_GPIO
	tegra_gpio_i2c.dev.platform_data = &lx_gpio_i2c_platform_data;
#endif
//                                                                             
	lx_i2c_dev_init();
//                                                                             
