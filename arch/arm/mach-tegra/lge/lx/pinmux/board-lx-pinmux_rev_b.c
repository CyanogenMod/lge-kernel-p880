/*
 * arch/arm/mach-tegra/board-lx-pinmux_rev_c.c
 *
...
static __initdata struct tegra_drive_pingroup_config lx_drive_pinmux[] = {
...
static __initdata struct tegra_pingroup_config lx_pinmux[] = {
...
//                                                                     
#if defined(CONFIG_MACH_LX_REV_B) && defined(CONFIG_MACH_LX_REV_A)
...
//                                                                                                                  
	...
	DEFAULT_PINMUX(GPIO_PV0,        RSVD,          NORMAL,    NORMAL,   INPUT),		//host-wakeup
//                                                       
...
#if !defined(CONFIG_MACH_LX) // remove warning in build time..
static __initdata struct tegra_pingroup_config lx_pinmux_e118x[] = {
	/* Power rails GPIO */
	DEFAULT_PINMUX(SPI2_SCK,        SPI2,            NORMAL,    NORMAL,     INPUT),
};

static __initdata struct tegra_pingroup_config lx_pinmux_e1198[] = {
	/* SPI2 */
	DEFAULT_PINMUX(SPI2_SCK,        SPI6,            PULL_UP,    NORMAL,     INPUT),
	DEFAULT_PINMUX(SPI2_MOSI,       SPI6,            PULL_DOWN,  TRISTATE,   INPUT),
	DEFAULT_PINMUX(SPI2_MISO,       SPI6,            PULL_DOWN,  NORMAL,     INPUT),
	DEFAULT_PINMUX(SPI2_CS0_N,      SPI6,            PULL_UP,    NORMAL,     INPUT),
	DEFAULT_PINMUX(SPI2_CS2_N,      SPI2,            PULL_UP,    TRISTATE,   INPUT),
};
#endif

int __init lx_pinmux_init(void)
{
	tegra_pinmux_config_table(lx_pinmux, ARRAY_SIZE(lx_pinmux));
	tegra_drive_pinmux_config_table(lx_drive_pinmux,
					ARRAY_SIZE(lx_drive_pinmux));
	return 0;
}
