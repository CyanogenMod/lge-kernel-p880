...
static const struct tegra_emc_table lx_emc_tables_k4p8g304eb[] = 
{
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table lx_emc_tables_k4p8g304eb_v32[] = {
	{
		0x32,       /* Rev 3.2 */
...
{
#if defined(EMC_REV_3_2)
	tegra_init_emc(lx_emc_tables_k4p8g304eb_v32,
		ARRAY_SIZE(lx_emc_tables_k4p8g304eb_v32));
#else
	tegra_init_emc(lx_emc_tables_k4p8g304eb,
		ARRAY_SIZE(lx_emc_tables_k4p8g304eb));
#endif
	return 0;
}
