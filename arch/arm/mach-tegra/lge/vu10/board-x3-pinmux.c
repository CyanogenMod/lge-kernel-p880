...
/******************************************************** Tables for VU1.0 [START] ********************************************************/
/* //////////////////////////////////////////////////////// Vu1.0 Rev.A [START] ///////////////////////////////////////////////////////// */
static __initdata struct tegra_drive_pingroup_config vu10_drive_pinmux_rev_A[] = {
...
static __initdata struct tegra_pingroup_config vu10_pinmux_rev_A[] = {
/*                                                                                                */
#if 0
...
//	DEFAULT_PINMUX(SDMMC3_DAT7,     RSVD,          PULL_UP,    TRISTATE,  OUTPUT),
    ...
    /*                                                              */
	DEFAULT_PINMUX(SDMMC4_CMD,      SDMMC4,          NORMAL,    NORMAL,     INPUT),	    //eMMC_CMD
...
//                                                                                                                             
	...
	DEFAULT_PINMUX(LCD_DE,          DISPLAYA,        PULL_DOWN, TRISTATE,   OUTPUT),
	DEFAULT_PINMUX(LCD_HSYNC,       DISPLAYA,        PULL_UP,   TRISTATE,   OUTPUT),
	DEFAULT_PINMUX(LCD_VSYNC,       DISPLAYA,        PULL_UP,   TRISTATE,   OUTPUT),
	...
	DEFAULT_PINMUX(LCD_M1,          DISPLAYA,        PULL_UP,   TRISTATE,   OUTPUT),
...
//                                                       
//org	DEFAULT_PINMUX(GPIO_PCC1,       I2S4,            PULL_UP,   TRISTATE,   INPUT),//MUIC_INIT
//org	DEFAULT_PINMUX(GPIO_PCC2,       I2S4,            PULL_UP,   NORMAL,     INPUT),//MUIC_INIT
...
//                                           
	...
	DEFAULT_PINMUX(KB_ROW2,       	RSVD,			 PULL_DOWN, NORMAL,		OUTPUT),//YJChae  20111026 change KEY_LED for GPIO //DEFAULT_PINMUX(KB_ROW2,         KBC,             PULL_UP, NORMAL,     INPUT),
...
//                                              
		...
		DEFAULT_PINMUX(SPDIF_OUT,	SPDIF,	 PULL_DOWN, NORMAL, OUTPUT),
#else
...
/* ///////////////////////////////////////////////////////// Vu1.0 Rev.B [START] ////////////////////////////////////////////////////////// */
static __initdata struct tegra_drive_pingroup_config vu10_drive_pinmux_rev_B[] = {
	/* DEFAULT_DRIVE(<pin_group>), */
	/* SET_DRIVE(ATA, DISABLE, DISABLE, DIV_1, 31, 31, FAST, FAST) */
//	SET_DRIVE(DAP2, 	DISABLE, ENABLE, DIV_1, 31, 31, FASTEST, FASTEST),
...
static __initdata struct tegra_pingroup_config vu10_pinmux_rev_B[] = {
...
//                                 
	...
	/*                                                                                          */
	DEFAULT_PINMUX(GMI_DQS,         GMI,             NORMAL,    NORMAL,     OUTPUT), /* SUB_MIC_BIAS_LDO_EN */
	/*                                                                                          */
...
/* //////////////////////////////////////////////////////// Vu1.0 Rev.N [START] ///////////////////////////////////////////////////////// */
static __initdata struct tegra_drive_pingroup_config vu10_drive_pinmux[] = {
	/* DEFAULT_DRIVE(<pin_group>), */
...
static __initdata struct tegra_pingroup_config x3_pinmux_rev_A[] = {
	...
	//DEFAULT_PINMUX(SDMMC3_DAT4,     SDMMC3,          PULL_UP,    TRISTATE,  INPUT),
//	DEFAULT_PINMUX(SDMMC3_DAT4,     RSVD,          PULL_UP,    NORMAL,  OUTPUT),
	//DEFAULT_PINMUX(SDMMC3_DAT5,     SDMMC3,          NORMAL,     NORMAL,    OUTPUT),   //SENSOR_LDO_EN (K3G, K3DH, AMI306 - VDD) check
	DEFAULT_PINMUX(SDMMC3_DAT5,     RSVD,            PULL_UP,    TRISTATE,  OUTPUT),
	//DEFAULT_PINMUX(SDMMC3_DAT6,     SDMMC3,          PULL_UP,    TRISTATE,  INPUT),
	DEFAULT_PINMUX(SDMMC3_DAT6,     SDMMC3,          NORMAL,     NORMAL,    OUTPUT),   // TOUCH_LDO_EN
	//DEFAULT_PINMUX(SDMMC3_DAT7,     SDMMC3,          NORMAL,     NORMAL,    OUTPUT),     //PROXI_LDO_EN (APDS990x - VDD)
	DEFAULT_PINMUX(SDMMC3_DAT7,     RSVD,          PULL_UP,    TRISTATE,  OUTPUT),     //PROXI_LDO_EN (APDS990x - VDD) check
#if 0
	/* eMMC */
	DEFAULT_PINMUX(SDMMC4_CLK,      VI_ALT3,         PULL_UP,    NORMAL,    INPUT),
	DEFAULT_PINMUX(SDMMC4_CMD,      I2C3,            PULL_UP,    TRISTATE,  INPUT),
...
//                                             
	/* I2C2 pinmux */
#if 0//                                                    
	I2C_PINMUX(GEN2_I2C_SCL,        I2C2,            NORMAL,	NORMAL,		INPUT,	DEFAULT,	DEFAULT),
	I2C_PINMUX(GEN2_I2C_SDA,        I2C2,            NORMAL,	NORMAL,		INPUT,	DEFAULT,	DEFAULT),
#else
...
//                                                      
	...
	/* SDMMC1 CD gpio */
	DEFAULT_PINMUX(CLK2_OUT,        RSVD1,      PULL_UP, NORMAL,   INPUT),	//MICROSD_DETECT_N
	DEFAULT_PINMUX(CLK2_REQ,        DAP,             NORMAL, NORMAL,     OUTPUT), //BT_RESET
	DEFAULT_PINMUX(LCD_PWR1,        DISPLAYA,        NORMAL,    NORMAL,     OUTPUT), //                                      
	//DEFAULT_PINMUX(LCD_PWR2,        DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_WR_N,        DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	...
	DEFAULT_PINMUX(LCD_DC0,         RSVD1,        NORMAL, NORMAL,   OUTPUT), 	//LCD_CP_EN
	DEFAULT_PINMUX(LCD_DC1, 		DISPLAYA,		 NORMAL,	NORMAL, 	OUTPUT),

//	DEFAULT_PINMUX(GMI_CS7_N,		RSVD,			 NORMAL,	NORMAL,	OUTPUT),

//                                                                     
#if defined(MACH_X3_REV_A) && defined(CONFIG_MACH_X3)
	DEFAULT_PINMUX(GMI_CS0_N,		RSVD,			 PULL_UP,	NORMAL, 	INPUT),  //NFC_IRQ
#endif
	DEFAULT_PINMUX(LCD_PWR0,        DISPLAYA,        NORMAL, NORMAL,   OUTPUT),  //                                      
	...
	/* UART3 - Bluetooth BCM4330 UART I/F */
	DEFAULT_PINMUX(UART3_TXD,       UARTC,           PULL_UP,   NORMAL,     OUTPUT), //BT_RX_AP_TX
	DEFAULT_PINMUX(UART3_RXD,       UARTC,           PULL_UP,   NORMAL,     INPUT),  //BT_TX_AP_RX
	DEFAULT_PINMUX(UART3_CTS_N,     UARTC,           PULL_UP,   NORMAL,     INPUT),  //BT_RTS_AP_CTS
	DEFAULT_PINMUX(UART3_RTS_N,     UARTC,           PULL_UP,   NORMAL,     OUTPUT), //BT_CTS_AP_RTS
	...
	/* I2S3 - Bluetooth BCM4330 PCM I/F */
	DEFAULT_PINMUX(DAP4_DIN,        I2S3,            PULL_DOWN, NORMAL,     INPUT),  //BT_PCM_DOUT
	DEFAULT_PINMUX(DAP4_DOUT,       I2S3,            PULL_DOWN, NORMAL,     OUTPUT), //BT_PCM_DIN
	DEFAULT_PINMUX(DAP4_FS,         I2S3,            PULL_DOWN, NORMAL,     OUTPUT), //BT_PCM_SYNC
	DEFAULT_PINMUX(DAP4_SCLK,       I2S3,            PULL_DOWN, NORMAL,     OUTPUT), //BT_PCM_CLK
...
//                                                                
	...
	DEFAULT_PINMUX(GMI_AD11,        PWM3,             NORMAL, NORMAL,   OUTPUT),
//                                 
	DEFAULT_PINMUX(GMI_AD12,        RSVD,             PULL_UP,    NORMAL,   INPUT),  //GYRO_INT (K3G - INT)
	DEFAULT_PINMUX(GMI_AD13,        RSVD,             PULL_UP,    NORMAL,   INPUT),  //COMPASS_INT (AMI306 - INT)
//                                 
	DEFAULT_PINMUX(GMI_AD14,        RSVD1,           PULL_UP,   NORMAL,  INPUT),    //MOTION_INT (K3DH - INT)
	DEFAULT_PINMUX(GMI_AD15,        GMI,             NORMAL,    TRISTATE,   INPUT),
	////////////////////////
	DEFAULT_PINMUX(GMI_A16,         UARTD,             NORMAL,    NORMAL,   OUTPUT),
	DEFAULT_PINMUX(GMI_A17,         UARTD,             NORMAL,    NORMAL,   INPUT),
...
//                                                       
//org	DEFAULT_PINMUX(GPIO_PCC1,       I2S4,            PULL_UP,   TRISTATE,   INPUT),
//org	DEFAULT_PINMUX(GPIO_PCC2,       I2S4,            PULL_UP,   NORMAL,     INPUT),
...
//                                           
	...
	DEFAULT_PINMUX(KB_ROW1,         KBC,             PULL_UP, NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_ROW2,       	RSVD,		 PULL_DOWN, NORMAL,		OUTPUT),	//KEY_LED_EN 	//YJChae  20111026 change KEY_LED for GPIO //DEFAULT_PINMUX(KB_ROW2,         KBC,             PULL_UP, NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_COL0,         KBC,             PULL_UP,   NORMAL,     INPUT),
...
//                                           
	...
	DEFAULT_PINMUX(KB_ROW10,        KBC,             PULL_DOWN, NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_ROW11,        KBC,             PULL_DOWN, NORMAL,     OUTPUT), //BT_WAKEUP
	DEFAULT_PINMUX(KB_ROW12,        KBC,             PULL_DOWN, TRISTATE,     INPUT),  //BT_HOST_WAKEUP
//                                                                                                                  
//                                                                                                                  

	DEFAULT_PINMUX(GPIO_PV0,        RSVD,          PULL_UP,    NORMAL,   INPUT),		//                               
//                                                      
//org	DEFAULT_PINMUX(GPIO_PV1,        RSVD,          NORMAL,    NORMAL,   INPUT),
...
static __initdata struct tegra_pingroup_config x3_pinmux_rev_B[] = {
	...
	//DEFAULT_PINMUX(SDMMC3_DAT4,     SDMMC3,          PULL_UP,    TRISTATE,  INPUT),
//	DEFAULT_PINMUX(SDMMC3_DAT4,     RSVD,          PULL_UP,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(SDMMC3_DAT5,     SDMMC3,          NORMAL,    NORMAL,  OUTPUT),    //SENSOR_LDO_EN (MPU6050, AMI306 - VDD)
//	DEFAULT_PINMUX(SDMMC3_DAT6,     SDMMC3,          PULL_UP,    TRISTATE,  INPUT),
	DEFAULT_PINMUX(SDMMC3_DAT6,     SDMMC3,          NORMAL,     NORMAL,    OUTPUT),   // TOUCH_LDO_EN
	DEFAULT_PINMUX(SDMMC3_DAT7,     SDMMC3,          NORMAL,    NORMAL,  OUTPUT),    //PROXI_LDO_EN (APDS990x - VDD)
#if 0
...
//                                           
	...
	/*  KBC keys */
	DEFAULT_PINMUX(KB_ROW0,         KBC,             PULL_UP, NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_ROW1,         RSVD,             NORMAL,   NORMAL,     OUTPUT), //hyojin.an 20120126 Camera Focuser DEFAULT_PINMUX(KB_ROW1,         KBC,             PULL_UP, NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_ROW2,       	RSVD,			 PULL_DOWN, NORMAL,		OUTPUT),//YJChae  20111026 change KEY_LED for GPIO //DEFAULT_PINMUX(KB_ROW2,         KBC,             PULL_UP, NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_COL0,         KBC,             PULL_UP,   NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_COL1,         KBC,             PULL_UP,   NORMAL,     INPUT),
	DEFAULT_PINMUX(KB_COL2,         KBC,             PULL_UP,   NORMAL,     INPUT), //TOUCH_MAKER_ID
...
//                                           
	...
	DEFAULT_PINMUX(KB_ROW12,        KBC,             PULL_DOWN, NORMAL,     INPUT),  //BT_HOST_WAKEUP
//                                                                                                                  
	DEFAULT_PINMUX(KB_ROW14,      RSVD,             NORMAL, NORMAL,     INPUT),	//cheol.gwak 0109 suspend request

//                                                                                                                  
	DEFAULT_PINMUX(KB_ROW15,	   RSVD,		     PULL_DOWN, NORMAL,	   OUTPUT), //cheol.gwak 0109 slave-wakeup

	DEFAULT_PINMUX(GPIO_PV0,        RSVD,          PULL_UP,    NORMAL,   INPUT),		//host-wakeup
//                                                      
//org	DEFAULT_PINMUX(GPIO_PV1,        RSVD,          NORMAL,    NORMAL,   INPUT),//MUIC_INIT
	DEFAULT_PINMUX(GPIO_PV1,        RSVD,          NORMAL,    NORMAL,   OUTPUT),//MUIC_INIT
//                                           
...
//                                          
	...
	case hw_rev_pcb_type_A:
		tegra_pinmux_config_table(vu10_pinmux_rev_A, ARRAY_SIZE(vu10_pinmux_rev_A));
		tegra_drive_pinmux_config_table(vu10_drive_pinmux_rev_A, ARRAY_SIZE(vu10_drive_pinmux_rev_A));
		break;
	case hw_rev_pcb_type_B:
		tegra_pinmux_config_table(vu10_pinmux_rev_B, ARRAY_SIZE(vu10_pinmux_rev_B));
		tegra_drive_pinmux_config_table(vu10_drive_pinmux_rev_B, ARRAY_SIZE(vu10_drive_pinmux_rev_B));
		break;
	default:
		tegra_pinmux_config_table(vu10_pinmux, ARRAY_SIZE(vu10_pinmux));
		tegra_drive_pinmux_config_table(vu10_drive_pinmux, ARRAY_SIZE(vu10_drive_pinmux));
		break;
	}
#else
	switch(x3_get_hw_rev_pcb_version())
