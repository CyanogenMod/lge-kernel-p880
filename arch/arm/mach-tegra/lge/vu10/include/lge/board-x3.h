...
typedef enum{
    ...
    hw_rev_pcb_type_1_3,
    hw_rev_pcb_type_MAX
}hw_rev_pcb_type;		// ref :<pcb_ver_info> Lge_boot_adc_tsc2007.c (android\vendor\lge\tegra\core\system\fastboot\lge_boot)
...
#define TEGRA_GPIO_SUB_MIC	TEGRA_GPIO_PI2
#else
//                                         
...
/*                                                                            */
#define TEGRA_BPC_TRIGGER		TEGRA_GPIO_PX6
/*                                                                            */
