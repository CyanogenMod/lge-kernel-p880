...
#define CPU_MILLIVOLTS {\
	750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887, 900, 912, 916, 925, 937, 950, 962, 975, 987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1200, 1225, 1252, 1275};

#ifdef CONFIG_USER_VOLTAGE_CONTROL
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ,   1,   1,   1, 456, 500, 500, 500, 600, 600, 600, 600,  700,  700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 1, MHZ,   1,   1,   1, 456, 500, 500, 500, 600, 600, 600, 600,  700,  700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 2, MHZ,   1,   1,   1, 456, 500, 500, 500, 600, 600, 600, 600,  700,  700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 3, MHZ,   1,   1,   1, 456, 500, 500, 500, 600, 600, 600, 600,  700,  700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700),

#else

	CPU_DVFS("cpu_g",  4, 0, MHZ,   1,   1,   1,   1, 460, 460, 460, 550, 550, 550, 550,  680,  680,  680,  820,  820,  970,  970,  970, 1040, 1040, 1080, 1080, 1150, 1150, 1200, 1200, 1240, 1240, 1280, 1280, 1320, 1320, 1360, 1360, 1500, 1500, 1500, 1500, 1500),
	CPU_DVFS("cpu_g",  4, 1, MHZ,   1,   1,   1,   1, 480, 480, 480, 650, 650, 650, 780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1250, 1250, 1300, 1300, 1330, 1330, 1360, 1360, 1400, 1400, 1500, 1500, 1500, 1500, 1500),
	CPU_DVFS("cpu_g",  4, 2, MHZ,   1,   1,   1,   1, 520, 520, 520, 700, 700, 700, 860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1280, 1280, 1300, 1300, 1340, 1340, 1380, 1380, 1500, 1500, 1500, 1500, 1500),
	CPU_DVFS("cpu_g",  4, 3, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  910,  910,  910, 1150, 1150, 1230, 1230, 1230, 1280, 1280, 1330, 1330, 1370, 1370, 1400, 1400, 1500, 1500, 1500, 1500, 1500),
...
static struct dvfs cpu_0_dvfs_table[] = {
	/* Cpu voltages (mV):	      750, 762, 775, 787, 800, 825, 837, 850, 862,  875,  887,  900,  912,  916,  925,  937,  950,  962,  975,  987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1200, 1225, 1252, 1270*/

#ifdef CONFIG_CPU_OC

	CPU_DVFS("cpu_0",  4, 0, MHZ,   1,   1,   1, 500, 500, 500, 600, 600, 600, 600,  700,  700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1500, 1600, 1600, 1700),
	CPU_DVFS("cpu_0",  4, 1, MHZ,   1,   1, 500, 500, 500, 600, 600, 600, 600, 700,  700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1500, 1600, 1600, 1700),
	CPU_DVFS("cpu_0",  4, 2, MHZ,   1, 500, 500, 500, 600, 600, 600, 600, 700, 700,  700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1500, 1600, 1600, 1700),
	CPU_DVFS("cpu_0",  4, 3, MHZ, 500, 500, 500, 600, 600, 600, 600, 700, 700, 700,  800,  800,  800,  900,  900, 900, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1500, 1500, 1500, 1600, 1600, 1700),

#else

	CPU_DVFS("cpu_0",  4, 0, MHZ,   1,   1,   1, 475, 475, 475, 475, 640, 640,  640,  760,  760,  760,  860,  860,  860, 1000, 1000, 1000, 1100, 1100, 1100, 1100, 1200, 1200, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500),
	CPU_DVFS("cpu_0",  4, 1, MHZ,   1, 475, 475, 475, 640, 640, 640, 760,  760,  760,  860,  860,  860, 1000, 1000, 1000, 1100, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500),
	CPU_DVFS("cpu_0",  4, 2, MHZ, 475, 475, 475, 640, 640, 760, 760, 760,  860,  860,  860, 1000, 1000, 1000, 1100, 1100, 1200, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500),
	CPU_DVFS("cpu_0",  4, 3, MHZ, 475, 475, 640, 640, 640, 760, 760, 860, 860,  860, 1000, 1000, 1000, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 0, 1, KHZ,        1, 294000, 342000, 427000, 475000,  500000,  500000,  620000,  620000),
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 1, 1, KHZ,   204000, 294000, 342000, 427000, 475000,  500000,  500000,  620000,  620000),
...
#else
	CORE_DVFS("emc", emc_millivolts, 2, 1, KHZ,   102000, 450000, 450000, 450000, 450000,  667000,  667000,  800000,  900000),
#endif
	...
	CORE_DVFS("sbus", core_millivolts, 1, 1, KHZ,   102000, 205000, 205000, 227000, 227000,  267000,  267000,  267000,  267000),
	CORE_DVFS("sbus", core_millivolts, 2, 1, KHZ,   102000, 205000, 205000, 227000, 227000,  267000,  334000,  334000,  334000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("sbus", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  216000,  216000,  216000),
#else
	CORE_DVFS("sbus", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  334000,  334000,  334000),
#endif
...
#ifdef CONFIG_MACH_X3
	CORE_DVFS("vi", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  400000,  300000,  300000),
#else
	CORE_DVFS("vi", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  470000,  470000,  470000),
#endif

	CORE_DVFS("vde", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("mpe", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("2d", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("epp", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("3d", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("3d2", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("se", avp_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),

	CORE_DVFS("vde", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("mpe", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("2d", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("epp", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("3d", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("3d2", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("se", avp_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),

	CORE_DVFS("vde", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("mpe", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("2d", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("epp", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("3d", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("3d2", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("se", avp_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),

	CORE_DVFS("vde", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  564000,  600000),
	CORE_DVFS("mpe", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  564000,  600000),
	CORE_DVFS("2d", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  564000,  600000),
	CORE_DVFS("epp", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  564000,  600000),
	CORE_DVFS("3d", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  564000,  600000),
	CORE_DVFS("3d2", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  564000,  600000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("se", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
#else
	CORE_DVFS("se", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  625000,  625000,  625000),
#endif

	CORE_DVFS("host1x", core_millivolts, 0, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  300000,  300000,  300000),
	CORE_DVFS("host1x", core_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  300000,  300000,  300000),
	CORE_DVFS("host1x", core_millivolts, 2, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  300000,  300000,  300000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("host1x", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  300000,  300000,  300000),
#else
	CORE_DVFS("host1x", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  300000,  300000,  300000),
#endif

	CORE_DVFS("cbus", core_millivolts, 0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("cbus", core_millivolts, 1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
	CORE_DVFS("cbus", core_millivolts, 2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  600000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("cbus", core_millivolts, 3, 1, KHZ,        1, 600000,  600000, 600000, 600000,  600000,  600000,  600000,  600000),
#else
	...
	CORE_DVFS("sdmmc4", core_millivolts, -1, 1, KHZ,   51000, 102000, 102000, 102000, 102000, 102000,  102000,   102000,  102000),
	CORE_DVFS("ndflash", core_millivolts, -1, 1, KHZ, 120000, 120000, 120000, 120000, 200000, 200000,  200000,   200000,  200000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("nor", core_millivolts, 0, 1, KHZ,       1, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
//                     
	CORE_DVFS("nor", core_millivolts, 1, 1, KHZ,   102000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor", core_millivolts, 2, 1, KHZ,   102000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor", core_millivolts, 3, 1, KHZ,       1,      1,      1,      1,      1,  108000,   108000,  108000),
#else
	CORE_DVFS("nor", core_millivolts, 0, 1, KHZ,        1, 115000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor", core_millivolts, 1, 1, KHZ,   102000, 115000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor", core_millivolts, 2, 1, KHZ,   102000, 115000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,      1,  108000,   108000,  108000),
#endif

#ifdef CONFIG_MACH_X3
	CORE_DVFS("sbc1", core_millivolts, -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc2", core_millivolts, -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc3", core_millivolts, -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc4", core_millivolts, -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc5", core_millivolts, -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc6", core_millivolts, -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
#else
	CORE_DVFS("sbc1", core_millivolts, -1, 1, KHZ,    36000,  52000,  60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc2", core_millivolts, -1, 1, KHZ,    36000,  52000,  60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc3", core_millivolts, -1, 1, KHZ,    36000,  52000,  60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc4", core_millivolts, -1, 1, KHZ,    36000,  52000,  60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc5", core_millivolts, -1, 1, KHZ,    36000,  52000,  60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc6", core_millivolts, -1, 1, KHZ,    36000,  52000,  60000,  60000,  60000, 100000,  100000,   100000,  100000),
#endif
	...
	CORE_DVFS("disp1", core_millivolts, 1, 0, KHZ,   155000, 155000, 268000, 268000, 268000, 268000,  268000,   268000,  268000),
	CORE_DVFS("disp1", core_millivolts, 2, 0, KHZ,   155000, 155000, 268000, 268000, 268000, 268000,  268000,   268000,  268000),
	...
	CORE_DVFS("disp2", core_millivolts, 1, 0, KHZ,   155000, 155000, 268000, 268000, 268000, 268000,  268000,   268000,  268000),
	CORE_DVFS("disp2", core_millivolts, 2, 0, KHZ,   155000, 155000, 268000, 268000, 268000, 268000,  268000,   268000,  268000),
	CORE_DVFS("disp2", core_millivolts, 3, 0, KHZ,        1, 120000, 120000, 120000, 120000, 190000,  190000,   190000,  190000),

	CORE_DVFS("pwm", core_millivolts, -1, 1, KHZ,   204000, 408000, 408000, 408000, 408000, 408000,  408000,   408000,  408000),
};
