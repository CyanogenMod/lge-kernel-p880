...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),

	CORE_DVFS("vde",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),

	CORE_DVFS("vde",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),

	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  528000,  564000,  600000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  528000,  564000,  600000),
	CORE_DVFS("2d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  528000,  564000,  600000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  528000,  564000,  600000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  528000,  564000,  600000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  528000,  564000,  600000),
#ifdef CONFIG_MACH_X3
	...
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  528000,  564000,  600000),
#ifdef CONFIG_MACH_X3
