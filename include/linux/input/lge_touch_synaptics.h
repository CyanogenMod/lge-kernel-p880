...
#define TOUCH_ADJUST_POSITION
#define TOUCH_GRIP_SUPPRESSION
#define TOUCH_FW_UPGRADE
...
#define LGE_TOUCH_RESOLUTION_X				1123
#define LGE_TOUCH_RESOLUTION_Y				1872
...
#define SYNAPTICS_DELTA_THRESHOLD				0x02
