...
*/
		...
		// 0xB2 : 0x3A, 0x0E
		{0, 0x00B2},
//		{0, 0x0146}, //Horizontal Back Porch Period
		{0, 0x0156}, //Horizontal Back Porch Period
		{0, 0x010A}, //Vertical Back Porch Period
		// 0xB3 : 0x08, 0x08
		{0, 0x00B3},
//		{0, 0x016E}, //Horizontal Front Porch Period
		{0, 0x0174}, //Horizontal Front Porch Period
		{0, 0x0118}, //Vertical Front Porch Period
...
//*/
		...
		{0, 0x01D7},	// 600Mbps 0xC8AB
		{0, 0x018C},	// 600Mbps 0xC8AB
		...
		{0, 0x0106},{0, 0x010A},{0, 0x010F},
		{0, 0x0114},{0, 0x011F},{0, 0x0117},
		{0, 0x0112},{0, 0x010C},{0, 0x0109},
		{0, 0x0106},
...
//                                                                                        
		...
		//Panel Driving Setting : Colume inversion
		{0, 0x00BC},{0, 0x0109},{0, 0x0100},
		{0, 0x00BF},
		{0, 0x01C1},{0, 0x0100},{0, 0x0110},//2Dot   //{0x0150}, //Column
...
struct spi_cmd_data16 solomon_reg_read_set[] = {
		...
		{0, 0x0102},
		{0, 0x00B2},
		{0, 0x0156}, // HBP + width(Because of the Non-burst mode)
		{0, 0x010A}, // VBP + width(Because of the Non-burst mode)
		// 0xB3 : 0x08, 0x08
		{0, 0x00B3},
		{0, 0x0174}, //HFP
		{0, 0x0118}, //VFP
...
//		{0, 0x0100},
		...
		{0, 0x00BF},
		{0, 0x01B0},{0, 0x0103},
#endif // HITACHI_GAMMA_S_CURVE END
