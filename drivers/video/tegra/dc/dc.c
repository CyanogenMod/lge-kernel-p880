...
static u8 hitach_gammalut[256] = {
	...
	0x6c, 0x6e, 0x6f, 0x70, 0x71, 0x73, 0x74, 0x75,
	0x76, 0x78, 0x79, 0x7a, 0x7b, 0x7d, 0x7e, 0x7f,
	0x80, 0x81, 0x82, 0x84, 0x85, 0x86, 0x87, 0x89,
	0x8a, 0x8b, 0x8c, 0x8e, 0x8f, 0x90, 0x91, 0x93,
	0x94, 0x95, 0x96, 0x98, 0x99, 0x9a, 0x9b, 0x9c,
	0x9e, 0x9f, 0xa0, 0xa1, 0xa2, 0xa4, 0xa5, 0xa6,
	0xa7, 0xa8, 0xa9, 0xab, 0xac, 0xad, 0xae, 0xaf,
	...
	0xed, 0xee, 0xef, 0xf0, 0xf1, 0xf1, 0xf2, 0xf3,
	...
	0xa4, 0xa5, 0xa6, 0xa8, 0xa9, 0xaa, 0xab, 0xac,
	0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb5,
...
/*                                 */
		...
		else if(cmdlineRGBvalue.table_type==GAMMA_NV_RETURNED){
			/*You have to consider AT%KCAL */
			win->ppflags |= TEGRA_WIN_PPFLAG_CP_ENABLE;
			lut = &dc->windows[i].lut;
			for (j = 0; j < 256; j++) {
