...
/* cpufreq_gaming Governor Tunables */
				   ...
				   unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		if (dbs_enable == 1) {
			...
			/*
			 * gaming does not implement micro like ondemand
...
MODULE_DESCRIPTION("'cpufreq_gaming' - A dynamic cpufreq governor for "
		"heavily gaming"
		"optimised for use in a battery environment");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_GAMING
